...
function generate_tags(notebook, bodyData) {
  ...
  return [
    ...
    `<meta property="og:url" content="https://diegoinacio.github.io/creative-coding-notebooks-page/pages/${notebook}.html">`,
    `<meta name="title" property="og:title" content="${bodyData.title} >> Creative Coding Notebooks | Diego Inácio">`,
    `<meta name="description" property="og:description" content="${bodyData.description}">`,
    `<meta name="image" property="og:image" content="https://diegoinacio.github.io/creative-coding-notebooks-page/images/thumb_${notebook}.jpg">`,
