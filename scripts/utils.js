...
function generate_tags(notebook, bodyData) {
  ...
  return [
    ...
    `<meta property="og:url" content="https://diegoinacio.github.io/creative-coding-notebooks/pages/${notebook}.html">`,
    ...
    `<meta name="image" property="og:image" content="https://diegoinacio.github.io/creative-coding-notebooks/images/thumb_${notebook}.jpg">`,
